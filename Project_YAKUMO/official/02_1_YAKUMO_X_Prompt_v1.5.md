...
v1.5はX上のヤクモの人格、口調、距離感、投稿方針を変更する更新ではなく、

> **YAKUMO_Visual_Bible_v2.0.mdおよびYAKUMO_Master_v3.0.png体系（Default Costume C01-Bの外装改訂を含む）へのReference Migration**

として扱う。MONYの人格・造形・Specificationは無変更である。
...
> **C01-B Victorian Gothic Cyber Style / Standard Form**
...
1. Master v3.0の顔造形を維持
2. Visual Bible v2.0の表情定義を適用
3. 投稿内容に必要な感情表現を加える
...
- `YAKUMO_Master_v3.0.png`を顔造形、身体比率、髪型、Standard Formの最優先基準とする
- `YAKUMO_Visual_Bible_v2.0.md`を外見ルール、配色、表情、Visual Coreの基準とする
- 通常指定では少女YAKUMOをStandard Formとして使用する
- Costume指定がない場合はC01-B Victorian Gothic Cyber Style / Standard Formを使用する
...
画像付きの日常投稿における基準顔は、Visual Bible v2.0のNORMAL表情とする。
...
| Visual Bible | `YAKUMO_Visual_Bible_v2.0.md` |
...
## v1.4 → v1.5 Change Log

- X Prompt Versionを**v1.4からv1.5へ更新**
- 本更新を**Default Costume C01-B再設計に伴うVisual Bible v2.0 / YAKUMO Master v3.0 Reference Migration**として定義
- Visual Bible参照を`YAKUMO_Visual_Bible_v1.3.md`から**`YAKUMO_Visual_Bible_v2.0.md`へ更新**
- YAKUMO Visual Master参照を`YAKUMO_Master_v2.0.png`から**`YAKUMO_Master_v3.0.png`へ更新**
- Default Costume表記を`C01-B Cyber Pleats Style`から**`C01-B Victorian Gothic Cyber Style`へ更新**（Costume Registry v1.4のC01-B改訂に伴う反映。Costume ID `C01-B`は継続使用）
- **MONYの人格・造形・Specification（`MONY v2.0 Specification v1.0 Official.md`、`MONY_Master_v2.0.png`、`MONY_Expression_Reference_v1.0.png`）への変更なし**
- **X運用ルール自体（話し方、投稿ジャンル、キャラクター濃度、絵文字・ω運用等）の変更なし**
- YAKUMOの人格、口調、投稿距離感、基本投稿方針は変更なし
- Character Bible v1.2の人格・世界観Authorityを継続
- Costume Registry、Special State Reference、MONY関連参照ファイルのバージョンはいずれも変更なし
