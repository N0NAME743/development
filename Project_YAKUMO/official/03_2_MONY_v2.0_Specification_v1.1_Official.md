...
# MONY v2.0 Specification v1.1 Official
...
1. 本書 `MONY v2.0 Specification v1.1 Official`
2. `MONY_Master_v2.0.png`
3. `YAKUMO_Visual_Bible_v2.0.md`
...
- YAKUMOのDefault Costume（C01-B）改訂に伴い、Visual Bible参照を`YAKUMO_Visual_Bible_v1.3.md`から`YAKUMO_Visual_Bible_v2.0.md`へ更新（19.2｜MONY v2.0 Visual Specification）
- 本更新はYAKUMO側のDefault Costume刷新に伴う参照更新のみであり、**MONY自身のVisual Core、Expression System、Operational State（NORMAL / COMMUNICATION / HACKING SYNC）には変更なし**
- **Official Visual Master `MONY_Master_v2.0.png`にも変更なし**（引き続き最優先ビジュアルリファレンス）
- MONYの人格・役割・YAKUMOとの関係性に変更なし
