...
| Character | **YAKUMO** |
| Standard Form | **少女ヤクモ** |
| Default Costume | **C01-B Victorian Gothic Cyber Style / Standard Form** |
...
| --- | --- | --- | --- | --- | --- | --- |
| **C01-B** | **Victorian Gothic Cyber Style** | Official Costume | Default / Cyber Street | 少女ヤクモ / Standard Form | `YAKUMO_Visual_Bible_v2.0.md` / `YAKUMO_Master_v3.0.png` | **Yes** |
| **C02** | **Cyber Beach Style** | Official Costume | Summer / Swimwear | 少女ヤクモ / Standard Form | `YAKUMO_Costume_C02_Cyber_Beach_v1.2.md` | No |
| **C03** | **Cyber Idol Style** | Official Costume | Stage / Idol | 少女ヤクモ / Standard Form | `YAKUMO_Costume_C03_Cyber_Idol_v1.2.md` | No |

C01-BのOfficial Nameは、v1.4でDefault Costumeの再設計に伴い**「Cyber Pleats Style」から「Victorian Gothic Cyber Style」へ変更**した。Costume ID `C01-B` は継続使用する。

C02およびC03は、今回のC01-B改訂によってデザイン・Status・Default指定を変更しない。共通参照ファイル（Visual Bible / Master）の更新反映のみ行う。
...
**C01-B Victorian Gothic Cyber Style / Standard Form**を使用する。
...
→ Default CostumeのVictorian Gothic Cyber Styleを使用する。

```text
Costume: C02
```

→ Official CostumeのCyber Beach Style v1.2を使用する。

```text
Costume: C03
```

→ Official CostumeのCyber Idol Style v1.2を使用する。

衣装を切り替えても、YAKUMO本人の顔・髪・身体・Visual Coreは別人化させない。

YAKUMO本人については、

- 実際の顔造形・身体比率・基本造形：`YAKUMO_Master_v3.0.png`
- 共通Visual Rule：`YAKUMO_Visual_Bible_v2.0.md`
...
### C01-B｜Victorian Gothic Cyber Style
...
| Specification | `YAKUMO_Visual_Bible_v2.0.md` |
| Official Visual Reference | `YAKUMO_Master_v3.0.png` |
| Prior Name | Cyber Pleats Style（v1.3以前のOfficial Name。`YAKUMO_Master_v2.0.png`はSupplementary Referenceとして継続保持） |
...
| Specification | `YAKUMO_Costume_C02_Cyber_Beach_v1.2.md` |
| Costume Reference | `YAKUMO_C02_Cyber_Beach_Reference_v1.0.png` |
| Notes | 黒主体のスポーティーなセパレート水着。C01-Bを置換しない。 |

C02 v1.2では、衣装デザインを変更せず、Visual Bible v2.0およびYAKUMO Master v3.0への参照更新のみを行っている。

C02に定義されたMONY用Summer Accessory等の衣装固有要素はC02仕様書を使用する。

MONY本人の現行造形・Expression・Operational Stateは、本Registry第8節およびC02 v1.2のReference Priorityを使用する。
...
| Form | 少女ヤクモ / Standard Form |
| Current Version | **v1.2** |
| Specification | `YAKUMO_Costume_C03_Cyber_Idol_v1.2.md` |
| Costume Reference | `YAKUMO_C03_Cyber_Idol_Reference_v1.0.png` |
| Notes | 黒×ピンクを核に、白フリルと限定的なゴールドを加えた左右非対称のステージ衣装。C01-Bを置換しない。 |

C03 v1.2では、衣装デザインを変更せず、Visual Bible v2.0およびYAKUMO Master v3.0への参照更新のみを行っている。

C03に定義されたMONY Motif、Stage Effect、Stage Integration等の衣装固有要素はC03仕様書を使用する。

MONY本人の現行造形・Expression・Operational Stateは、本Registry第8節およびC03 v1.2のReference Priorityを使用する。
...
- `C01-B`は既存Default Costumeの正式IDとして維持する（v1.4でOfficial Nameのみ改訂）
...
```text
YAKUMO_Costume_C02_Cyber_Beach_v1.2.md
YAKUMO_C02_Cyber_Beach_Reference_v1.0.png
YAKUMO_Costume_C03_Cyber_Idol_v1.2.md
...
> **C01-B Default Costume Redesign Reflection Update**

として扱う。C01-Bのシルエット・主要構造自体の再設計はVisual Bible v2.0（MAJOR更新）側で行われており、Registry自体の更新はOfficial Name・参照ファイルの反映が主体である。
...
- C01-B → `YAKUMO_Visual_Bible_v2.0.md`
- C02 → `YAKUMO_Costume_C02_Cyber_Beach_v1.2.md`
- C03 → `YAKUMO_Costume_C03_Cyber_Idol_v1.2.md`
...
現行MONYの造形にはMaster v2.0を使用する体系を継続する。

---

### 8.5｜C02 / C03 Current MONY Integration

C02 v1.2およびC03 v1.2は、いずれもMONY v2.0体系（Specification v1.1）への参照を維持している。

C02 / C03でMONYが登場する場合は、**各Specificationに定義された現行Reference Priorityを直接使用する。**

C02 v1.2ではMONY v2.0とFloat Ringの役割分離を継続している。  
C03 v1.2でもMONY v2.0とStage Effect / Motifの役割分離を継続している。
...
`YAKUMO HACKING MODE Specification v1.2 Official`は、
...
HACKING MODEではMONYもOperational State `HACKING SYNC`として扱われ、別形態へ再設計しないことが明確化されている。
...
```text
YAKUMO/
├─ YAKUMO Character Bible v1.3.md
...
│
├─ MONY/
│  └─ MONY v2.0 Specification v1.1 Official.md
│
├─ SPECIAL_STATES/
│  └─ YAKUMO HACKING MODE Specification v1.2 Official.md
│
├─ COSTUMES/
...
│
└─ archive/
   ├─ YAKUMO_Master_v2.0.png — Supplementary
...
5. YAKUMO本人が`YAKUMO_Master_v3.0.png`および`YAKUMO_Visual_Bible_v2.0.md`と整合していることを確認する
...
| C02 Current Version | **v1.2** |
| C03 Current Version | **v1.2** |
...
- Registry Versionを**v1.3からv1.4へ更新**
- 本更新を**C01-B Default Costume Redesign Reflection Update**として定義
- C01-BのOfficial Nameを**「Cyber Pleats Style」から「Victorian Gothic Cyber Style」へ変更**（Costume ID `C01-B` は継続使用）
- C01-BのSpecification参照を`YAKUMO_Visual_Bible_v1.3.md`から**`YAKUMO_Visual_Bible_v2.0.md`へ更新**
- C01-BのOfficial Visual Referenceを`YAKUMO_Master_v2.0.png`から**`YAKUMO_Master_v3.0.png`へ更新**
- `YAKUMO_Master_v2.0.png`をC01-B旧デザイン確認用の**Supplementary Reference**として整理
- C02のCurrent Versionを**v1.1からv1.2へ更新**（Visual Bible / Master参照更新のみ、衣装デザイン変更なし）
- C03のCurrent Versionを**v1.1からv1.2へ更新**（Visual Bible / Master参照更新のみ、衣装デザイン変更なし）
- MONY Specification参照を`v1.0 Official`から**`v1.1 Official`へ更新**（Visual Bible参照更新のみ、MONY造形に変更なし）
- HACKING MODE Specification参照を`v1.1 Official`から**`v1.2 Official`へ更新**（参照更新のみ）
- Character Bible参照を`v1.2`から**`v1.3`へ更新**
- Recommended Directory StructureをRegistry v1.4、C02 v1.2、C03 v1.2、Master v3.0体系へ更新
- C01-B v1.3以前の参照、C02 v1.1、C03 v1.1、Registry v1.3をarchive例へ移行
- **Registered Official Costumesは3着のまま変更なし**
- **C02 / C03自体の衣装デザイン変更なし**
- **新規Costume IDの追加なし**
